...
export function calc(){
  ...
  const mediaVar = parseBRL(document.getElementById('mediaVar').value);
  ...
  const fgtsBase = parseBRL(document.getElementById('fgtsBase').value);
  ...
  const art480 = parseBRL(document.getElementById('art480').value);
  const outrosDesc = parseBRL(document.getElementById('outrosDesc').value);
